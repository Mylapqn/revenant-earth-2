...
export type ObjectKind = "Player" | "Terrain" | "Atmo" | "Entity" | "Scene" | "ProgressDB" | "Weather" | "Ambience";
...
export function initHandlers() {
    ...
    StateManager.addHandler("Weather", Weather.deserialise);
    ...
    StateManager.addHandler("Ambience", Ambience.deserialise)
}

...
import { HitboxGeneratorOptions } from "./hitboxGeometry";
import { clamp } from "../utils/utils";
import { Vector } from "../utils/vector";
import { game, Game } from "../game";

export class AboveSurfaceGeometry extends Geometry {
    constructor(options: HitboxGeneratorOptions) {
        const { positions, uvs } = AboveSurfaceGeometry.getPositions(options);
